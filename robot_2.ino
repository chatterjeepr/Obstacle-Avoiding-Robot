...
#define TRIG_PIN A5 // Pin A0 on the Motor Drive Shield soldered to the ultrasonic sensor
#define ECHO_PIN A4 // Pin A1 on the Motor Drive Shield soldered to the ultrasonic sensor
...
void turnRight() {
  ...
  delay(980); // run motors this way for 900        
  motorSet = "FORWARD";
